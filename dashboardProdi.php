...
<html lang="en">
    <head>
        ...
        <title>Dashboard Prodi - SIMAKE</title>
                                ...
                                <div class="card welcome-card text-center">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4 pt-3 border-top">
                                            <p class="text-muted">Gunakan menu di samping kiri untuk mengelola <strong>Ajukan RAPBF</strong> Anda.</p>
                                            <a href="rapbf.php" class="btn btn-primary px-4 py-2 mt-2">
                                                <i class="fas fa-upload me-2"></i>Ajukan RAPBF Sekarang
                                            </a>
                                        </div>
                                    </div>
                                </div>
